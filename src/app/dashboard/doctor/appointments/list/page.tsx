                ...
                <div className="flex items-center justify-between p-6 border-b">
                    ...
                    <div className="flex gap-2">
                        {hasSelectedAppointments && (
                            <>
                                <Button btnTitle="✓ Confirm Selected" onClick={() => { }} className="bg-green-600 hover:bg-green-700 text-white">
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="border-b">
                            ...
                            <TableHead className="font-semibold text-gray-700">Appointment ID</TableHead>
                    ...
                    <TableBody>
                        {sampleAppointments.map((appointment) => (
                            <TableRow key={appointment.id} className="hover:bg-gray-50">
                                ...
                                <TableCell className="text-gray-700">{appointment.dateTime}</TableCell>
                                ...
                                <TableCell>
                                    <div className="flex gap-2">
                                        ...
                                        <Button
                                            onClick={() => { }}
                                            icon={<Trash variant="Bold" color="red" className="h-4 w-4" />}
